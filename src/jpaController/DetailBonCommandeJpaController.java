...
public class DetailBonCommandeJpaController extends SuperClass implements Serializable {
    ...
    public int getDetailBonCommandeCount() {
     ...
     public List<DetailBonCommande> findDetailBonByIdBon(BonCommande b) {
        em = getEntityManager();
        List<DetailBonCommande> l=  em.createNamedQuery("DetailBonCommande.findByIdBon")
                                       .setParameter("idBonCommande", b)
                                        .getResultList();
            em.close();
            return l;
        }
